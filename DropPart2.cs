...
{
    public class DropPart2 : StoryboardObjectGenerator
    {
        [Group("Colors")]
        [Configurable]
        ...
        public override void Generate()
        {
            ...
            var bgShowTime = 120662;
            var bgEndShowTime = 153128;
            var styleChangeTime = 142605;
            ...
            ParticlesRotateAroundPerson(@"sb\white.png", bgShowTime, styleChangeTime, 5000, 20, 400, 70, 3, 3.0, 310, 0.4, false, true, false);
            ParticlesRotateAroundPerson(@"sb\t.png", bgShowTime, styleChangeTime, 5000, 20, 310, 70, 3, 0.1, 390, 0.4, false, true, false);
            ParticlesRotateAroundPerson(@"sb\dot.png", bgShowTime, styleChangeTime, 5000, 20, 355, 70, 3, 5.0, 350, 0.4, false, true, false);
            ...
            ParticlesRotateAroundPerson(@"sb\white.png", styleChangeTime, bgEndShowTime, 5000, 20, 400, 70, 3, 3.0, 310, 0.4, true, true, false);
            ParticlesRotateAroundPerson(@"sb\t.png", styleChangeTime, bgEndShowTime, 5000, 20, 310, 70, 3, 0.1, 390, 0.4,true, true, false);
            ParticlesRotateAroundPerson(@"sb\dot.png", styleChangeTime, bgEndShowTime, 5000, 20, 355, 70, 3, 5.0, 350, 0.4, false, true, false);
            ...
            gradient.Fade(bgShowTime, styleChangeTime, 0.1, 0.2);
            gradient.Rotate(bgShowTime, styleChangeTime, 0, Math.PI/8);
            gradient.Additive(bgShowTime);
            gradient.MoveX(bgShowTime, styleChangeTime, -1600, -1500);
            gradient.Fade(styleChangeTime, styleChangeTime + beatDuration, 0.2, 0);
