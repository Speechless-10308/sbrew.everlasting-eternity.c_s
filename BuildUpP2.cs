...
{
    public class BuildUpP2 : StoryboardObjectGenerator
    {
        [Group("Colors")]
        [Configurable]
        ...
        public override void Generate()
        {
            ...
            var bgShowTime = 109690;
            var bgStartShowTime = 115176;
            var bgEndShowTime = 119976;
            ...
            var whiteShowTime = 119290;
            var whiteEndShowTime = 119976;
            var white = effectLayer.CreateSprite("sb/white.png", OsbOrigin.Centre);
            white.ScaleVec(whiteEndShowTime, 854.0f / 5.0, 480.0f / 5.0);
            white.Additive(whiteEndShowTime);
            white.Fade(whiteEndShowTime - 300, whiteEndShowTime, 0, 1);
